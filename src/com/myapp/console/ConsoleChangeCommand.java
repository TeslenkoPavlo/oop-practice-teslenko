 ...
 * Цей клас є конкретною реалізацією команди, що змінює дані об'єктів.
 * Він створює копію оригінальних даних перед їх модифікацією, що є
 * фундаментальним підходом для реалізації можливості скасування (undo).
 * У методі execute() зберігаються початкові значення об'єктів в ArrayList,
 * що дозволяє відновити їх при потребі скасування.
 * 
 * Завдання 4: Забезпечити діалоговий інтерфейс із користувачем.
 * Клас забезпечує інтерактивну взаємодію через консоль, використовуючи
 * кольорове форматування та інформативні повідомлення для покращення
 * зручності користування. Виводить порівняльну таблицю оригінальних і
 * модифікованих значень.
 * 
