...
/**
 * Консольне меню. Реалізує шаблон "Макрокоманда" (Composite).
 * 
 * @author Тесленко Павло
 * @version 2.0
 * 
 * Реалізує завдання 2: Продемонструвати поняття "макрокоманда".
 * Клас CommandMenu виступає як макрокоманда, що містить та керує
 * набором інших команд, які додаються до списку commands.
 * 
 * Реалізує завдання 4: Забезпечити діалоговий інтерфейс із користувачем.
 * Використовує BufferedReader для зчитування введення користувача з консолі
 * та виконує команди на основі вибору користувача.
 *
 */
