 ...
 * Цей клас підтримує концепції шаблону Command для забезпечення можливості
 * скасування операцій. Методи viewSave() та viewRestore() серіалізують
 * поточний стан таблиці у файл та відновлюють його, що є основним механізмом
 * реалізації функціональності undo в програмі.
 * 
 * Завдання 4: Забезпечити діалоговий інтерфейс із користувачем.
 * Метод viewShow() відповідає за відображення даних користувачу в зручному
 * форматованому вигляді, що є частиною діалогового інтерфейсу програми.
 * 
